...
Build an Angular application for production and learn how to deploy a performant Angular application`,
		coverImage: '/assets/images/angular.webp',
	},
	{
		id: 2,
...
John Resig is an acknowledged JavaScript authority and the creator of the jQuery library. Bear Bibeault is a web developer and author of the first edition, as well as coauthor of Ajax in Practice, Prototype and Scriptaculous in Action, and jQuery in Action from Manning. Josip Maras is a post-doctoral researcher and teacher.`,
		coverImage: '/assets/images/ninja-js.webp',
	},
	{
		id: 3,
...
Dive in hands-on: Use TypeScript with your favorite frontend and backend frameworks, migrate your existing JavaScript project to TypeScript, and run your TypeScript application in production`,
		coverImage: '/assets/images/type-script.webp',
	},
	{
		id: 4,
...
Redis version 3.2 or higher`,
		coverImage: '/assets/images/node-js.webp',
	},
	{
		id: 5,
